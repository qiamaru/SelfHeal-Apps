...
import 'beadhome2.dart';

class Meditate3 extends StatefulWidget {
  const Meditate3({super.key});

  @override
  State<Meditate3> createState() => _Meditate3State();
}

class _Meditate3State extends State<Meditate3> {
  @override
