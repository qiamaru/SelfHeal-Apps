...
class dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text(
        'Fabalous! You\'re good in this!',
        textAlign: TextAlign.center,
      ),
      content: const Text('Your reflex is good.', textAlign: TextAlign.center),
      actions: [
        Center(
            child: ElevatedButton(
                onPressed: (() {
                  ...
                  if (Provider.of<Status>(context, listen: false).stat7 != 5 &&
                      Provider.of<IsNotGreen>(context, listen: false)
                          .isnotgreen) {
                    context.read<Status>().chg('d7', 2, uid);
