...
class Cognitive7 extends StatefulWidget {
  const Cognitive7({super.key});

  @override
  State<Cognitive7> createState() => _Cognitive7State();
}

class _Cognitive7State extends State<Cognitive7> {
  @override
