...
import 'package:test_firebaseauth/game/Day2/meditate2/watchmotivational.dart';
...
class Meditate2 extends StatefulWidget {
  const Meditate2({super.key});

  @override
  State<Meditate2> createState() => _Meditate2State();
}

class _Meditate2State extends State<Meditate2> {
  @override
        ...
        body: Scaffold(
            ...
            body: Center(
                child: Column(
                  ...
                  Text(
                    'Watch on How to Combat Laziness',
                    // textAlign: TextAlign.center,
                      ...
                      child: ElevatedButton(
                        onPressed: (() {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: ((context) => WatchMotivational())));
                        }),
                        child: Padding(
