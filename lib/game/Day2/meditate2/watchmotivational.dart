...
class WatchMotivational extends StatefulWidget {
  const WatchMotivational({super.key});

  @override
  State<WatchMotivational> createState() => _WatchMotivationalState();
}

class _WatchMotivationalState extends State<WatchMotivational> {
  ...
  void initState() {
    ...
    const url = 'https://www.youtube.com/watch?v=8u3q04UHE_o';
