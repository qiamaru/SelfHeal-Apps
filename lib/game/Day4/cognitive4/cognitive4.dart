...
import 'package:test_firebaseauth/game/Day4/cognitive4/mazerunner.dart';
...
class Cognitive4 extends StatefulWidget {
  const Cognitive4({super.key});

  @override
  State<Cognitive4> createState() => _Cognitive4State();
}

class _Cognitive4State extends State<Cognitive4> {
  @override
