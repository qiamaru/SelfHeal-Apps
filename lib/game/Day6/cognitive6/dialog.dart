...
class dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text(
        'Splendid. You calculated it well',
        textAlign: TextAlign.center,
      ),
      content: const Text('You successfully solved the Sliding Puzzle!',
          textAlign: TextAlign.center),
      actions: [
        Center(
            child: ElevatedButton(
                onPressed: (() {
                  ...
                  if (Provider.of<Status>(context, listen: false).stat6 != 5 &&
                      Provider.of<IsNotGreen>(context, listen: false)
                          .isnotgreen) {
                    context.read<Status>().chg('d6', 2, uid);
