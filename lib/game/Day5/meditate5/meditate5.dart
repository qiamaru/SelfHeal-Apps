...
import 'beadhome3.dart';

class Meditate5 extends StatefulWidget {
  const Meditate5({super.key});

  @override
  State<Meditate5> createState() => _Meditate5State();
}

class _Meditate5State extends State<Meditate5> {
  @override
